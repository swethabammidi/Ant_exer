 ...
 */
public class TrademarksTC extends RequestResponse implements ActionInterface {
	private static Logger L = Logger.getLogger(SPProps.getFELogName(TrademarksTC.class));
	...
	public String doAction(HttpServletRequest req, HttpServletResponse resp)
		...
		L.info("doAction():" + logTag +
			"User has entered the Trademarks TC page, with the following session: "+get_session().getId());
		SPProps.infoLogger.info("TrademarksTC.doAction():" + logTag +
			"User has entered the Trademarks TC page, with the following session: "+get_session().getId());
		return "mobileWeb/trademarksTC.jsp";
	}
