...
public class LogLoader extends HttpServlet implements Servlet {
	...
	*/
	...
	private void printLogs(PrintWriter out)
	{
		...
		out.println("Root Logger = <b>" + rL.getName() + "</b>, Level = <b>" + rL.getLevel() + "</b><br>");
		...
		while (en.hasMoreElements())
		{
			...
			out.println("Logger Name = <b>" + L.getName() + "</b>, Level = <b>" + L.getLevel() + "</b><br>");
		}
	...
	*/
	public void init() throws ServletException {
		...
		logId = System.getProperty("LOGID");
		if(logId != null)
			propFile = propPath + File.separator + "log4j.sp." + logId + ".properties";
		else
